...
import useInfomodule from '@/hooks/useInfomodule';
        ...
        " />
          ...
          ">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <FavoriteButton movieId={data?.id} />
                        <div onClick={() => openModal(data?.id)} className='curosr-pointer ml-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center transition hover:border-neutral-300'>
